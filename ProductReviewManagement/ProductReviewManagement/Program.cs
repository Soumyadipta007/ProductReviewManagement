    ...
    class Program
    {
        static void Main(string[] args)
        {
            List<ProductReview> productReviewList = new List<ProductReview>()
            {
                ...
                new ProductReview(){ProducID=2,UserID=10,Rating=4,Review="Good",isLike=true},
                ...
                new ProductReview(){ProducID=13,UserID=10,Rating=5,Review="Good",isLike=true},
                new ProductReview(){ProducID=14,UserID=10,Rating=6,Review="Good",isLike=false},
                new ProductReview(){ProducID=15,UserID=10,Rating=2,Review="nice",isLike=true},
                ...
                new ProductReview(){ProducID=20,UserID=10,Rating=8,Review="nice",isLike=true},
                ...
                new ProductReview(){ProducID=22,UserID=10,Rating=8,Review="nice",isLike=true},
